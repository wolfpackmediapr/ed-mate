...
<body>
    <section class="auth d-flex">
        <div class="auth-left d-none d-lg-flex">
            <img src="<?= base_url('assets/images/thumbs/auth-img1.png') ?>" alt="Register" class="img-fluid">
        </div>
        <div class="auth-right">
            <div class="auth-right__inner">
                ...
                <p class="text-muted mb-4">Sign up to get started with Edmate</p>
                ...
                <form method="post" action="<?php echo base_url('register'); ?>">
                    ...
                    <button type="submit" class="btn btn-main w-100 mb-4">Register</button>
