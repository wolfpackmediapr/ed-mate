...
<body>
    ...
    <section class="auth d-flex">
        <div class="auth-left bg-main-50 flex-center p-24">
            <img src="<?= asset_url() ?>images/thumbs/auth-img1.png" alt="">
        </div>
        <div class="auth-right py-40 px-24 flex-center flex-column">
            <div class="auth-right__inner mx-auto w-100">
                <a href="index.html" class="auth-right__logo">
                    <img src="<?= asset_url() ?>images/logo/logo.png" alt="">
                </a>
            ...
            <form action="<?php echo base_url('login'); ?>" method="POST">
                <div class="mb-24">
                    ...
                    <div class="position-relative">
                        <input name="username" type="text" class="form-control py-11 ps-40" id="fname" placeholder="Type your username">
                ...
                <div class="mb-24">
                    ...
                    <div class="position-relative">
                        <input name="password" type="password" class="form-control py-11 ps-40" id="current-password" placeholder="Enter Current Password">
                ...
                <p class="mt-32 text-gray-600 text-center">New on our platform?
                    <button type="submit" class="text-main-600 hover-text-decoration-underline">Create an account</button>
                </p>
