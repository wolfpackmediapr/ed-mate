            ...
            <div class="card mt-24">
                ...
                <div style="display: none;" class="card-body" id="card-body-2">
                    <div class="row gy-4">
                        ...
                        <div class="col-12">
                            <div class="flex-align justify-content-end gap-8">
                                <button onclick="TabsNew(1)" type="reset" class="btn btn-outline-main bg-main-100 border-main-100 text-main-600 rounded-pill py-9">Back</button>
                                <button onclick="publishLesson()" type="button" class="btn btn-main rounded-pill py-9">Save Changes</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="item_${file.upload_id}" class="upload-card-item p-16 rounded-12 bg-main-50 mb-20">
                            <div class="flex-between flex-wrap gap-4">
                                <div class="flex-align gap-10">
                                    <video id="video_${file.upload_id}" class="video-js vjs-big-play-centered w-88 h-56 rounded-8" controls preload="auto" data-setup='{}'>
...
<script>
// After appending each video, initialize Video.js
setTimeout(function() {
  if (window.videojs) {
