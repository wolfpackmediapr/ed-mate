                                    ...
                                    <?php
                                     if (!empty($resources)) {
                                        foreach ($resources as $resIndex => $resource) {
                                            ...
                                            // If the user has paid, all courses are active, otherwise only the first two
                                            $class = ($is_paid || $resIndex < 2) ? 'active' : 'disabled';
                                            $is_active = $is_paid || $resIndex < 2; // Flag to check if the course is active based on payment or index
