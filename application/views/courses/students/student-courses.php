                            ...
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <div class="card border border-gray-100">
                                    <div class="card-body p-8">
                                        <a href="<?= base_url('student-course-details') ?>/<?= $course->course_id ?>" class="bg-main-100 rounded-8 overflow-hidden text-center mb-8 h-164 flex-center p-8">
                                            <img src="<?= base_url() ?>uploads/courses/<?= $course->thumbnail_image ?>" alt="Course Image">
                                        </a>
                                        <div class="p-8">
                                            <span class="text-13 py-2 px-10 rounded-pill bg-success-50 text-success-600 mb-16"><?= $course->category_name ?></span>
                                            <h5 class="mb-0"><a href="<?= base_url('student-course-details') ?>/<?= $course->course_id ?>" class="hover-text-main-600"><?= $course->course_title ?></a></h5>
                                            ...
                                            <div class="flex-align gap-8 flex-wrap mt-16">
                                                ...
                                                <div>
                                                    <span class="text-gray-600 text-13">Created by <a href="profile.html" class="fw-semibold text-gray-700 hover-text-main-600 hover-text-decoration-underline"><?= $course->username ?></a> </span>
                                            ...
                                            <a href="<?= base_url('student-course-details') ?>/<?= $course->course_id ?>" class="btn btn-outline-main rounded-pill py-9 w-100 mt-24">Continue Classes</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
