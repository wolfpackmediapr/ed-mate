        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-onGoing" role="tabpanel" aria-labelledby="pills-onGoing-tab" tabindex="0">
                    <div id="courses-container" class="row g-20">
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="card border border-gray-100">
                                <div class="card-body p-8">
                                    <a href="student-course-details.html" class="bg-main-100 rounded-8 overflow-hidden text-center mb-8 h-164 flex-center p-8">
                                    ...
                                    <div class="p-8">
                                        ...
                                        <h5 class="mb-0"><a href="student-course-details.html" class="hover-text-main-600">Full Stack Web Development</a></h5>
                                        ...
                                        <a href="student-course-details.html" class="btn btn-outline-main rounded-pill py-9 w-100 mt-24">Continue Classes</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card border border-gray-100">
                                <div class="card-body p-8">
                                    ...
                                    <div class="p-8">
                                        ...
                                        <h5 class="mb-0"><a href="student-course-details.html" class="hover-text-main-600">UI/UX Design Course</a></h5>
                            ...
                            <div class="card border border-gray-100">
                                <div class="card-body p-8">
                                    ...
                                    <div class="p-8">
                                        ...
                                        <h5 class="mb-0"><a href="student-course-details.html" class="hover-text-main-600">React Native Courese</a></h5>
                            ...
                            <div class="card border border-gray-100">
                                <div class="card-body p-8">
                                    ...
                                    <div class="p-8">
                                        ...
                                        <h5 class="mb-0"><a href="student-course-details.html" class="hover-text-main-600">SEO Expert A To Z Course</a></h5>
                    ...
                    <div class="card border border-gray-100">
                        <div class="card-body p-8">
                            ...
                            <div class="p-8">
                                ...
                                <a href="student-course-details.html" class="btn btn-outline-main rounded-pill py-9 w-100 mt-24">Start The Mentoring</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="card border border-gray-100">
                        <div class="card-body p-8">
                            ...
                            <div class="p-8">
                                <span class="text-13 py-2 px-10 rounded-pill bg-warning-50 text-warning-600 mb-16">Design</span>
                                <h5 class="mb-0"><a href="student-course-details.html" class="hover-text-main-600">Design System</a></h5>
                    ...
                    <div class="card border border-gray-100">
                        <div class="card-body p-8">
                            ...
                            <div class="p-8">
                                ...
                                <h5 class="mb-0"><a href="student-course-details.html" class="hover-text-main-600">Search Engine Optimization</a></h5>
                    ...
                    <div class="card border border-gray-100">
                        <div class="card-body p-8">
                            ...
                            <div class="p-8">
                                ...
                                <h5 class="mb-0"><a href="student-course-details.html" class="hover-text-main-600">React Js</a></h5>
                    ...
                    <div class="card border border-gray-100">
                        <div class="card-body p-8">
                            ...
                            <div class="p-8">
                                ...
                                <h5 class="mb-0"><a href="student-course-details.html" class="hover-text-main-600">WordPress Development</a></h5>
                    ...
                    <div class="card border border-gray-100">
                        <div class="card-body p-8">
                            ...
                            <div class="p-8">
                                ...
                                <h5 class="mb-0"><a href="student-course-details.html" class="hover-text-main-600">Content Writing</a></h5>
                    ...
                    <div class="card border border-gray-100">
                        <div class="card-body p-8">
                            ...
                            <div class="p-8">
                                ...
                                <h5 class="mb-0"><a href="student-course-details.html" class="hover-text-main-600">Artificial Inteligence</a></h5>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderCourse(course) {
        return `
            <div class="col-xxl-3 col-lg-4 col-sm-6">
                <div class="card border border-gray-100">
                    <div class="card-body p-8">
                        <a href="${course.url}" class="bg-main-100 rounded-8 overflow-hidden text-center mb-8 h-164 flex-center p-8">
                            <img src="${course.thumbnail}" alt="Course Image">
                        </a>
                        <div class="p-8">
                            <span class="text-13 py-2 px-10 rounded-pill bg-success-50 text-success-600 mb-16">${course.category}</span>
                            <h5 class="mb-0"><a href="${course.url}" class="hover-text-main-600">${course.title}</a></h5>

                            <div class="flex-align gap-8 mt-12">
                                <span class="text-main-600 flex-shrink-0 text-13 fw-medium">${course.progress}%</span>
                                <div class="progress w-100 bg-main-100 rounded-pill h-8" role="progressbar" aria-label="Course Progress" aria-valuenow="${course.progress}" aria-valuemin="0" aria-valuemax="100">
                                    <div class="progress-bar bg-main-600 rounded-pill" style="width: ${course.progress}%"></div>
                                </div>
                            </div>
                            <div class="flex-align gap-8 flex-wrap mt-16">
                                <img src="${course.creator_avatar || '<?= base_url('assets/images/thumbs/user-img.png') ?>'}" class="w-32 h-32 rounded-circle object-fit-cover" alt="User Image">
                                <div>
                                    <span class="text-gray-600 text-13">Created by <a href="#" class="fw-semibold text-gray-700 hover-text-main-600 hover-text-decoration-underline">${course.creator}</a></span>
                                    <div class="flex-align gap-4">
                                        <span class="text-15 fw-bold text-warning-600 d-flex"><i class="ph-fill ph-star"></i></span>
                                        <span class="text-13 fw-bold text-gray-600">${course.rating.score}</span>
                                        <span class="text-13 fw-bold text-gray-600">(${course.rating.count})</span>
                                    </div>
                                </div>
                            </div>
                            <a href="${course.url}" class="btn btn-outline-main rounded-pill py-9 w-100 mt-24">Continue Classes</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    function loadCourses() {
        ...
        fetch('<?= base_url('student-courses/getStudentCourses') ?>')
            .then(response => response.json())
            .then(data => {
                hideLoading();
                if (data.success) {
                    coursesContainer.innerHTML = data.data.map(course => renderCourse(course)).join('');
                } else {
                    showError();
                }
            })
    ...
    document.querySelectorAll('[data-bs-toggle="pill"]').forEach(tab => {
        tab.addEventListener('shown.bs.tab', function (e) {
            if (e.target.id === 'pills-onGoing-tab') {
                loadCourses();
            }
        });
    });
