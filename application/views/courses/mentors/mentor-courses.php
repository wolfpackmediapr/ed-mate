                            ...
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <div class="card border border-gray-100">
                                    <div class="card-body p-8">
                                        <a href="<?= base_url('course-details') ?>/<?= $course->course_id ?>" class="bg-main-100 rounded-8 overflow-hidden text-center mb-8 h-164 flex-center p-8">
                                        ...
                                        <div class="p-8">
                                            ...
                                            <h5 class="mb-0"><a href="<?= base_url('course-details') ?>/<?= $course->course_id ?>" class="hover-text-main-600"><?= $course->course_title ?></a></h5>
                                            ...
                                            <a href="<?= base_url('course-details') ?>/<?= $course->course_id ?>" class="btn btn-outline-main rounded-pill py-9 w-100 mt-24">Continue Classes</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
