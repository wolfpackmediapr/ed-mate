            ...
            <div id="display-selected-course" class="card">
                <div class="card-body p-lg-20 p-sm-3">
                    ...
                    <div class="rounded-16 overflow-hidden">
                        <video id="player" class="player" playsinline controls data-poster="<?= htmlspecialchars($course->thumbnail_image) ?>">
                            <source src="<?= htmlspecialchars($video_path) ?>" type="video/mp4">
                            <source src="<?= htmlspecialchars($video_path) ?>" type="video/webm">
                        </video>
                    </div>
