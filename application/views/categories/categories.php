                     ...
                     <tbody>
                         ...
                         <?php foreach ($categories as $category) { ?>
                             <tr>
                                 ...
                                 <td>
                                     <span class="h6 mb-0 fw-medium text-gray-300"><?= $category->category_id ?></span>
                                 </td>
                                 <td>
                                     <div class="flex-align gap-8">

                                         <span class="h6 mb-0 fw-medium text-gray-300"><?= $category->category_name ?></span>
                                     </div>
                                 </td>
                                 <td>
                                     <span class="h6 mb-0 fw-medium text-gray-300"><?= $category->createdAt ?></span>
                                 </td>
