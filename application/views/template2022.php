...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="<?php echo asset_url(); ?>images/logo/favicon.png">
  <!-- Bootstrap -->
  <link rel="stylesheet" href="<?php echo asset_url(); ?>css/bootstrap.min.css">
  <!-- file upload -->
  <link rel="stylesheet" href="<?php echo asset_url(); ?>css/file-upload.css">
  <!-- file upload -->
  <link rel="stylesheet" href="<?php echo asset_url(); ?>css/plyr.css">
  <!-- DataTables -->
  <link rel="stylesheet" href="https://cdn.datatables.net/2.0.8/css/dataTables.dataTables.min.css">
  <!-- full calendar -->
  <link rel="stylesheet" href="<?php echo asset_url(); ?>css/full-calendar.css">
  <!-- jquery Ui -->
  <link rel="stylesheet" href="<?php echo asset_url(); ?>css/jquery-ui.css">
  <!-- editor quill Ui -->
  <link rel="stylesheet" href="<?php echo asset_url(); ?>css/editor-quill.css">
  <!-- apex charts Css -->
  <link rel="stylesheet" href="<?php echo asset_url(); ?>css/apexcharts.css">
  <!-- calendar Css -->
  <link rel="stylesheet" href="<?php echo asset_url(); ?>css/calendar.css">
  <!-- jvector map Css -->
  <link rel="stylesheet" href="<?php echo asset_url(); ?>css/jquery-jvectormap-2.0.5.css">
  <!-- Main css -->
...
<body>
  ...
  <!-- jQuery Validate plugin (must be after jQuery, before custom JS) -->
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.5/jquery.validate.min.js"></script>
  <!-- Bootstrap Bundle Js (fix path if needed) -->
  <script src="<?php echo asset_url(); ?>js/bootstrap.bundle.min.js"></script>
  <!-- SweetAlert2 (must be before custom JS that uses Swal) -->
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  <!-- Phosphor Js -->
  <script src="<?php echo asset_url(); ?>js/phosphor-icon.js"></script>
  <!-- file upload -->
  <script src="<?php echo asset_url(); ?>js/file-upload.js"></script>
  <!-- file upload -->
  <script src="<?php echo asset_url(); ?>js/plyr.js"></script>
  <!-- dataTables -->
  <script src="https://cdn.datatables.net/2.0.8/js/dataTables.min.js"></script>
  <!-- full calendar -->
  <script src="<?php echo asset_url(); ?>js/full-calendar.js"></script>
  <!-- jQuery UI -->
  <script src="<?php echo asset_url(); ?>js/jquery-ui.js"></script>
  <!-- jQuery UI -->
  <script src="<?php echo asset_url(); ?>js/editor-quill.js"></script>
  <!-- apex charts -->
  <script src="<?php echo asset_url(); ?>js/apexcharts.min.js"></script>
  <!-- Calendar Js -->
  <script src="<?php echo asset_url(); ?>js/calendar.js"></script>
  <!-- jvectormap Js -->
  <script src="<?php echo asset_url(); ?>js/jquery-jvectormap-2.0.5.min.js"></script>
  <!-- jvectormap world Js -->
  ...
  <script src="<?php echo asset_url(); ?>js/create-course.js"></script>
