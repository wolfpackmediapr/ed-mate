...
if ($_SERVER['HTTP_HOST'] == "localhost") {
	$config['base_url'] = "http://localhost/edmate/";
} elseif (strpos($_SERVER['HTTP_HOST'], '192') !== false) {
	$config['base_url'] = getSiteURL();
} else {
	// 	$config['base_url'] = getSiteURL();
	$config['base_url'] = 'https://portal.lakecountyphysicaltherapy.com/';
}


if ($_SERVER['HTTP_HOST'] == "localhost") {
	$config['stripe_key'] = 'pk_test_qblFNYngBkEdjEZ16jxxoWSM';
	$config['stripe_secret'] = 'sk_test_26PHem9AhJZvU623DfE1x4sd';
} else {
	$config['stripe_key']       = 'pk_test_qblFNYngBkEdjEZ16jxxoWSM';
	$config['stripe_secret']    = 'sk_test_26PHem9AhJZvU623DfE1x4sd';
}
...
|
*/
$config['encryption_key'] = 'MDB^i7IJ84;#N9~';
