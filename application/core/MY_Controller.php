...
class MY_Controller extends CI_Controller
{
	function __construct()
	{
		...
		header("Content-Security-Policy: default-src 'self'; script-src 'self' 'unsafe-inline' cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' cdn.jsdelivr.net; img-src 'self' data: blob:; font-src 'self'; connect-src 'self' https://your-supabase-project.supabase.co;");
	}
